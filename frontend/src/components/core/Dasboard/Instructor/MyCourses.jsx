...
const MyCourses = () => {
  ...
  function redirectToAddCourse(){
   ...
   async function loadCourse(courseID){
     const response=await apiconnector('POST','http://localhost:4000/api/v1/course/load-course',{courseID})
  ...
  async function deleteCourse(){
    ...
    const response= await apiconnector('DELETE','http://localhost:4000/api/v1/course/delete-course',{courseID:deleteCourseID})
    ...
    const fetchallCourse=async()=>{
        const response=await apiconnector('GET','http://localhost:4000/api/v1/course/get-instructor-courses')  
