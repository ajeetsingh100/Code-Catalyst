...
import {showIncomeState,showStudentState} from '../../PieChart/PieChart'
...
const MyDashboard = () => {
      ...
      useEffect(()=>{
        const loadUserStat=async()=>{
            const response=await apiconnector("get",'http://localhost:4000/api/v1/course/get-instructor-stat')
