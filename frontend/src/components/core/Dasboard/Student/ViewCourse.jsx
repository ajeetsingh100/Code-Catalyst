...
import CourseVideo from '../../ViewCourse/CourseVideo'
...
const ViewCourse = () => {
    ...
    const courseDetail= async()=>{
      const response= await apiconnector("POST",`http://localhost:4000/api/v1/course/get-full-course-details`,{courseId:courseID})
