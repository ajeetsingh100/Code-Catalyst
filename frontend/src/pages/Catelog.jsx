...
const Catelog = () => {
  ...
  async function findAllCategory(){
    const response=await apiconnector("GET",'http://localhost:4000/api/v1/course/show-all-categories')
  ...
  async function setSearchedCategory(){
    ...
    const response=await apiconnector('POST','http://localhost:4000/api/v1/course/get-category-page-details',{categoryID:categoryFound._id})
