...
import ReviewCards from '../components/core/CourseDetail/ReviewCards'
...
const CourseDetailPage = () => {
  ...
  const [courseDetails,setCourseDetails]=useState(null)
    ...
    async function loadCourseDetails(){
      const response=await apiconnector('POST','http://localhost:4000/api/v1/course/get-course-details',{courseID:courseID})
